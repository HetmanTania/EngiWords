import {
  ...
  userNameRegex,
  passwordRegex,
} from "~/utils/validation/regExp.js";
...
const errorsMessageRegister = {
  email: {
    EMAIL_IS_INCORRECT_FORMAT:
      "The mailing address must contain from 3 to 10 characters of the Latin alphabet in the format example@example.com",
  },
  userName: {
    USERNAME_IS_INCORRECT_FORMAT:
      "The username must contain from 3 to 10 characters of the Latin alphabet",
  },
  password: {
    PASSWORD_IS_INCORRECT_FORMAT:
      "The password must contain symbols and/or numbers",
  },
};
...
export const errorMessageFromServer = {
  ...
  server_error:
    "A general error has occurred on the server. Please try again after some time.",
