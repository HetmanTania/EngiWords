<template>
  <div
    class="w-[329px] h-[59px] bg-primary-200 flex items-center justify-around rounded-full"
  >
    <label
      :class="[
        { 'bg-secondary-900': isCurrent(valueFirstRadio) },
        baseLabelClass,
      ]"
      for="login"
      >{{ textFirstRadio }}
    ...
    <label
      :class="[
        { 'bg-secondary-900': isCurrent(valueSecondRadio) },
        baseLabelClass,
      ]"
      for="registration"
      >{{ textSecondRadio }}
